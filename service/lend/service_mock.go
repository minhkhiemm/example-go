...
//             CreateFunc: func(ctx context.Context, p *domain.Lend) error {
// 	               panic("TODO: mock out the Create method")
//             },
//             DeleteFunc: func(ctx context.Context, p *domain.Lend) error {
// 	               panic("TODO: mock out the Delete method")
//             },
//             FindFunc: func(ctx context.Context, p *domain.Lend) (*domain.Lend, error) {
// 	               panic("TODO: mock out the Find method")
//             },
//             FindAllFunc: func(ctx context.Context) ([]domain.Lend, error) {
// 	               panic("TODO: mock out the FindAll method")
//             },
//             UpdateFunc: func(ctx context.Context, p *domain.Lend) (*domain.Lend, error) {
...
func (mock *ServiceMock) Create(ctx context.Context, p *domain.Lend) error {
...
func (mock *ServiceMock) Delete(ctx context.Context, p *domain.Lend) error {
...
// Find calls FindFunc.
func (mock *ServiceMock) Find(ctx context.Context, p *domain.Lend) (*domain.Lend, error) {
...
func (mock *ServiceMock) FindAll(ctx context.Context) ([]domain.Lend, error) {
...
func (mock *ServiceMock) Update(ctx context.Context, p *domain.Lend) (*domain.Lend, error) {
